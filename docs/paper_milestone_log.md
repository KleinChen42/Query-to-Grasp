...
| Query-pick plus oracle-place StackCube bridge | Query-derived cubeA targets with privileged oracle cubeB placement target | `outputs/h200_60071_query_stackcube_place_bridge_seed0_49/reports/query_place_comparison.md` |
...
| Query-driven StackCube placement bridge | Done | `outputs/h200_60071_query_stackcube_place_bridge_seed0_49/reports/query_place_comparison.md` | Query-derived cubeA targets plus privileged oracle cubeB placement complete all six 50-seed modes. Single-view reaches `task_success_rate = 0.7200`; tabletop_3 reaches `0.5200`; closed-loop reaches `0.4800`. This upgrades StackCube from pick-only compatibility to a partial oracle-place bridge without claiming fully non-oracle stacking. |
