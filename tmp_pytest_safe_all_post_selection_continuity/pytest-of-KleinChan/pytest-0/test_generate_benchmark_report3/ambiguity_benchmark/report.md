...
- Benchmark directory: `E:\CODE\Query-to-Grasp\tmp_pytest_safe_all_post_selection_continuity\pytest-of-KleinChan\pytest-0\test_generate_benchmark_report3\ambiguity_benchmark`
...
| pick_success_rate | 0 |
| fraction_top1_changed_by_rerank | 0.5000 |
| mean_runtime_seconds | 1.5000 |
| pick_stage_counts | `{"placeholder_not_executed": 1}` |

## Ambiguity Conclusion

Reranking has measurable opportunity in this benchmark setting.
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| object | 1 | 2 | 2 | 1 | 10 | 1 | 0 | 0.5000 | 1.5000 |
